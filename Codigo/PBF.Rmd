...
```{r}
knitr::kable(summary,caption='Resumen de las variables', align = 'c', format = 'pipe', big.mark = ",",digits = 2)
```
...
```{r}
ggplot(data, aes(x=pc_pbf_pop)) + geom_boxplot()
```
