...
ggplot(ps_data, aes(x = distance, fill = match)) +
  ...
  labs(x = "Propensity Score", y = "Density", fill = "Matching") +
  ggtitle("Propensity Score Distribution Before and After Matching") +
  theme_minimal() +
...
Texto sobre las gráficas y las distribuciones.
...
Texto sobre las distrbuciones pegadas.
